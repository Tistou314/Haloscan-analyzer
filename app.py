...
if has_dual_haloscan:
    ...
    df_p1 = df_p1.rename(columns={'ancienne_pos':'pos_debut_p1','derniere_pos':'pos_fin_p1','diff_pos':'diff_p1'})
    df_p2 = df_p2.rename(columns={'ancienne_pos':'pos_debut_p2','derniere_pos':'pos_fin_p2','diff_pos':'diff_p2'})
    df = df_p1.merge(df_p2[['mot_cle','url','pos_debut_p2','pos_fin_p2','diff_p2']], on=['mot_cle','url'], how='outer', suffixes=('','_p2'))
